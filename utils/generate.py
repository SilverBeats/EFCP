...
def generate(
    ...
    cs_token_id = cs_token_id if cs_token_id is not None else self.config.cs_token_id
...
def postprocess_next_token_scores(
    ...
    if cs_token_id is not None and cur_len > min_length:
        scores[:, cs_token_id] = -1e20
